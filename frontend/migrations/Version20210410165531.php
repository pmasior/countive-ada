 ...
 */
final class Version20210410165531 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT NOT NULL, icon_id INT DEFAULT NULL, user_account_id INT NOT NULL, name VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_64C19C154B9D732 ON category (icon_id)');
        $this->addSql('CREATE INDEX IDX_64C19C13C0C9956 ON category (user_account_id)');
        $this->addSql('CREATE TABLE category_budget (id INT NOT NULL, category_id INT NOT NULL, amount NUMERIC(21, 8) NOT NULL, since TIMESTAMP(0) WITH TIME ZONE NOT NULL, until TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE method_of_payment (id INT NOT NULL, icon_id INT DEFAULT NULL, settlement_account_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE settlement_account (id INT NOT NULL, user_account_id INT NOT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(25) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_687E93CB3C0C9956 ON settlement_account (user_account_id)');
        $this->addSql('CREATE TABLE subcategory (id INT NOT NULL, icon_id INT DEFAULT NULL, category_id INT NOT NULL, name VARCHAR(100) NOT NULL, color VARCHAR(25) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subcategory_budget (id INT NOT NULL, subcategory_id INT NOT NULL, amount NUMERIC(21, 8) NOT NULL, since TIMESTAMP(0) WITH TIME ZONE NOT NULL, until TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C1C7329B5DC6FE57 ON subcategory_budget (subcategory_id)');
        $this->addSql('CREATE TABLE tag (id INT NOT NULL, category_id INT NOT NULL, name VARCHAR(25) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_389B78312469DE2 ON tag (category_id)');
        $this->addSql('CREATE TABLE transaction (id INT NOT NULL, currency_id INT NOT NULL, subcategory_id INT NOT NULL, settlement_account_id INT NOT NULL, method_of_payment_id INT DEFAULT NULL, amount NUMERIC(21, 8) NOT NULL, added_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, note VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C13C0C9956 FOREIGN KEY (user_account_id) REFERENCES user_account (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE settlement_account ADD CONSTRAINT FK_687E93CB3C0C9956 FOREIGN KEY (user_account_id) REFERENCES user_account (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
