 ...
 */
class SubcategoryOwnerExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    private $security;
    ...
    private function addWhereOnlyOwner(string $resourceClass, QueryBuilder $queryBuilder): void
    {
        ...
        $queryBuilder->innerJoin($rootAlias . '.subcategory', 's')
            ->innerJoin('s.category', 'c')
            ->andWhere('c.userAccount = :userAccountId')
